App = {
    ...
    initContracts: function() {
        $.getJSON("JAY19IT001TokenSale.json", function(JAY19IT001TokenSale) {
            ...
            App.contracts.JAY19IT001TokenSale.deployed().then(function(
                JAY19IT001TokenSale
            ) {
                console.log(
                    "JAY19IT001 Token Sale Address:",
                    JAY19IT001TokenSale.address
                );
            });
        }).done(function() {
    ...
    render: function() {
        ...
        if (web3.currentProvider.enable) {
            ...
            web3.currentProvider.enable().then(function(acc) {
                ...
                document.getElementById(
                    "accountAddress"
                ).innerText = `Your Account: ${App.account}`;
            });
        } else {
        ...
        App.contracts.JAY19IT001TokenSale.deployed()
            ...
            .then(function(tokensSold) {
                ...
                // Load token contract
                App.contracts.JAY19IT001.deployed()
                    .then(function(instance) {
